...

{
    /* <AnimatePresence>
                      {isOpen && (
                          <motion.div className="md:hidden fixed top-0 right-0 h-full w-64 bg-gray-900 bg-opacity-80 backdrop-blur-sm text-white flex flex-col items-start p-8 space-y-6 z-50"
                              variants={variants}
                              initial="closed"
                              animate="open"
                              exit="closed"
                          ...
                          >
                              <button
                                  className="absolute top-4 right-4 text-purple-900 hover:text-white transition duration-300"
